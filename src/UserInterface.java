...
public class UserInterface {
        ...
        while (true) {
            ...
            switch (cmd) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    System.out.print("Введите id задачи, которую хотите удалить из истории просмотров: ");
                    int idFromHistory = scanner.nextInt();
                    manager.removeTaskFromHistory(idFromHistory);
                    break;
                case 14:
                    return;
                default:
    ...
    public static void printMenu() {
        ...
        System.out.println("13 - Удалить задачу из истории просмотров.");
